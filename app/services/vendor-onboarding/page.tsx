...
const successStories = [
  {
    ...
    growth: "400%",
    story: "Increased sales by 400% within 6 months of joining RUACH platform",
    avatar: "FK"
  },
  {
    name: "Tech Gadgets Nigeria",
    category: "Electronics",
    growth: "250%",
    story: "Expanded from local to nationwide delivery and tripled customer base",
    avatar: "TG"
  },
  {
    ...
    growth: "350%",
    story: "Built a loyal customer base and launched 3 new product lines",
    avatar: "NB"
  }
]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Vendor Success Stories</h2>
            <p className="text-lg text-gray-600">Real businesses achieving real growth on RUACH</p>
          </div>
